// src/components/LegalPages/Impressum.jsx
import React from 'react';
import { getLegalTranslation } from '../../data/legalTranslations';
import { TRANSLATIONS } from '../../data/translations';

const Impressum = ({ onBack, translations }) => {
  ...
  const getCurrentLanguage = () => {
    ...
    console.log('startButton:', translations?.startButton);
  ...
  // Body-Layout für Impressum überschreiben
  React.useEffect(() => {
    ...
    <div style={{
      ...
      <div style={{ 
        ...
        <h1 style={{ 
          ...
          {getLegalTranslation(language, 'impressumTitle')}
        </h1>
        ...
        <div style={{
          ...
          <h2 style={{ 
            ...
            {getLegalTranslation(language, 'tmgHeading')}
          </h2>
          <p style={{ 
            color: '#005B97', 
            fontSize: '18px', 
            ...
            {getLegalTranslation(language, 'tmgText')}
          </p>
        </div>
        ...
        <div style={{
          ...
          <h2 style={{ 
            ...
            {getLegalTranslation(language, 'contactHeading')}
          </h2>
          <p style={{ 
            color: '#005B97', 
            fontSize: '18px', 
            ...
            {getLegalTranslation(language, 'contactText')}
          </p>
        </div>
        ...
        <div style={{
          ...
          <h2 style={{ 
            ...
            {getLegalTranslation(language, 'taxIdHeading')}
          </h2>
          <p style={{ 
            color: '#005B97', 
            fontSize: '18px', 
            ...
            {getLegalTranslation(language, 'taxIdText')}
          </p>
        </div>
        ...
        <div style={{
          ...
          <h2 style={{ 
            ...
            {getLegalTranslation(language, 'responsibleHeading')}
          </h2>
          <p style={{ 
            color: '#005B97', 
            fontSize: '18px', 
            ...
            {getLegalTranslation(language, 'responsibleText')}
          </p>
        </div>
        ...
        <div style={{
          ...
          <h2 style={{ 
            ...
            {getLegalTranslation(language, 'contentLiabilityHeading')}
          </h2>
          <p style={{ 
            color: '#005B97', 
            fontSize: '18px', 
            ...
            {getLegalTranslation(language, 'contentLiabilityText')}
          </p>
        </div>
        ...
        <div style={{
          ...
          <h2 style={{ 
            ...
            {getLegalTranslation(language, 'linksLiabilityHeading')}
          </h2>
          <p style={{ 
            color: '#005B97', 
            fontSize: '18px', 
            ...
            {getLegalTranslation(language, 'linksLiabilityText')}
          </p>
        </div>
        ...
        <div style={{
          ...
          <h2 style={{ 
            ...
            {getLegalTranslation(language, 'copyrightHeading')}
          </h2>
          <p style={{ 
            color: '#005B97', 
            fontSize: '18px', 
            ...
            {getLegalTranslation(language, 'copyrightText')}
          </p>
        </div>
